...
let location1;  // location1 of ball_1
let velocity1;  // velocity1 of ball_1
let gravity1;   // gravity1 of ball_1

let location2;  // location1 of ball_2
let velocity2;  // velocity1 of ball_2
let gravity2;   // gravity1 of ball_2
...
function draw() {
  ...
  ellipse(location1.x,location1.y,48,48);
   ellipse(location2.x,location2.y,58,58);
}